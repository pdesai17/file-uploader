import { Handler, WorkflowContext, WorkflowEvent, WorkflowEventData } from "@llama-flow/core";
...
type Handler$1<AcceptEvents extends WorkflowEvent<any>[], Result extends WorkflowEventData<any> | void> = (...event: {
