...
//#endregion
const __llama_flow_core_async_context = __toESM(require("@llama-flow/core/async-context"));
...
const _executorAsyncLocalStorage = (0, __llama_flow_core_async_context.createAsyncContext)();
function getContext() {
	const context = _executorAsyncLocalStorage.getStore();
	if (!context) throw new Error("No current context found");
	return context;
}
const handlerContextAsyncLocalStorage = (0, __llama_flow_core_async_context.createAsyncContext)();
		...
		get stream() {
			...
			return new ReadableStream({
				start: async (controller) => {
					unsubscribe = rootWorkflowContext.__internal__call_send_event.subscribe((newEvent) => {
